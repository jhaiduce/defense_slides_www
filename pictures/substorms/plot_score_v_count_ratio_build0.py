...
if __name__=='__main__':
    ...
    fig=plot_skill_score_v_count_ratio(runprops,obs_thresholds=[2.5],model_thresholds=[2.5],show_circle=False,skip_styles=2)
    fig.savefig('score_v_count_ratio_build0.svg')
