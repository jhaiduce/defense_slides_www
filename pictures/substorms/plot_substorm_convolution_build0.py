...
if __name__=='__main__':
    ...
    fig=make_convolution_figure(obs_signatures,threshold,tstart,tend,bandwidth=timedelta(minutes=10),show_onsets=False,show_all=False,show_scores=False,show_individual_onsets=True)
